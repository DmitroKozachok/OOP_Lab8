...
template <> constexpr inline auto Player::qt_create_metaobjectdata<qt_meta_tag_ZN6PlayerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(std::shared_ptr<Track>)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->currentTrackChanged((*reinterpret_cast<std::add_pointer_t<std::shared_ptr<Track>>>(_a[1]))); break;
        ...
        case 3: _t->stateChanged((*reinterpret_cast<std::add_pointer_t<QMediaPlayer::PlaybackState>>(_a[1]))); break;
        case 4: _t->play(); break;
        case 5: _t->pause(); break;
        case 6: _t->stop(); break;
        case 7: _t->playIndex((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Player::*)(std::shared_ptr<Track> )>(_a, &Player::currentTrackChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)(qint64 )>(_a, &Player::positionChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)(qint64 )>(_a, &Player::durationChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)(QMediaPlayer::PlaybackState )>(_a, &Player::stateChanged, 3))
            return;
    }
}
...
// SIGNAL 0
void Player::currentTrackChanged(std::shared_ptr<Track> _t1)
{
